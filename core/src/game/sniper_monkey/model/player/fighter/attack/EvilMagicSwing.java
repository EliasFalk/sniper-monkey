...
public class EvilMagicSwing extends AttackObject {
    ...
    public EvilMagicSwing(float damage, float timeToLive, Vector2 playerPos, int collisionMask, boolean lookingRight) {
        super(damage, timeToLive, playerPos, collisionMask);

        Vector2 attackHitboxPos = playerPos.add(lookingRight ? 0 : -attackHitboxSize.x, 0);
